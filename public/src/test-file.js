function forLoops(books) {
    // let count = 0;
    // let genreArray = [];
      
      
        let mostPopGenres = books.forEach((book) => {
            const { genre } = book;
            books.filter((bookGenre) => {
                
    })
})

    console.log(mostPopGenres);
    //return mostPopGenres;

    // sortedArray.forEach((book) => {
    //     const {genre} = book;
    //     console.log(genre);
    //     if (!mostPopGenres) {
    //         mostPopGenres.push(genre.genre);
    //     }
    // })
    ...
    //     genreArray.sort((a, b) => {
    //     return a > b ? 1 : -1;
    //     // genreArray.forEach((book) => {

    //     // })
    // })

    // let genreArray = books.forEach((book) => {
    //     for (let i = 0; i < book.length; i++) {
    //         let currentGenre = book.genre[i];
    //         let count = 0;
    //         if (book) {
    //             mostPopGenres.push(currentGenre);
    //             // Need to create object count key before this to return to
    //             count++;
    //         } else if (count > 0) {
    //             // Same here; create object count key
    //             count++;
    //         }
    //     }
    // })
    
    let result = "End of Test";
    console.log(result);
}
